...
contract DSCEngine is ReentrancyGuard {
     ...
     * @param tokenCollateralAddress The collateral addrss to redeem
    ...
    // Conditions:
    // Health factor must be over 1 AFTER collateral pull
     ...
     * @param user The user who you wish to liquidate
     * @param debtToCover The amount of DSC you want to burn to improve user's health factor
     * @notice You can partially liquidate a user
     * @notice You will get a transaction bonus for taking the user's funds
     * @notice This function's working assumes the protocol will be roughly 200% overcollateralized for this to work
     * @notice A known bug would be if the protocol is 100% or less collateralized, then we wouldn't be able to incentivize the liquidator
     */
